...
public class G
{
    ...
    public G (String type)
    {
        ...
        } else if (type.equals("oriented weighted graph"))
        {
            ...
            uG = null;
            oUWG = null;
        } else System.out.println("Такой тип графа не поддерживается!");
    }
    ...
    public void setGraph(HashMap<String, List<String>> graph)
    {
        ...
        } else System.out.println("Граф не был создан!");
    }
    public void setGraph(UndirectedGraph graph)
    {
        if (this.type.equals("undirected graph")) this.uG.setGraph(graph.getGraph());
        else System.out.println("Граф имеет другой тип или не был создан!");
    }
    public void setGraph(OrientedUnWeightedGraph graph)
    {
        if (this.type.equals("oriented unweighted graph")) this.oUWG.setGraph(graph.getGraph());
        else System.out.println("Граф имеет другой тип или не был создан!");
    }
    public void setGraph(OrientedWeightedGraph graph)
    {
        if (this.type.equals("oriented weighted graph")) this.oUWG.setGraph(graph.getGraph());
        else System.out.println("Граф имеет другой тип или не был создан!");
    }

    public Graph getGraph()
    {
        if (this.type.equals("undirected graph") && this.uG != null) return this.uG;
        else if (this.type.equals("oriented unweighted graph") && this.oUWG != null) return this.oUWG;
        else if (this.type.equals("oriented weighted graph") && this.oWG != null) return this.oWG;
        else
        {
