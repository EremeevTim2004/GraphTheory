...
public abstract class Graph
{
    ...
    public boolean getStatus() {return this.isNormal;}
    ...
    public void setGraph(Graph graph) {setGraph(graph.getGraph());}
    public HashMap<String, List<String>> getGraph() {return new HashMap<String, List<String>>(this.graph);}
    ...
    public Vertex getVertex(String name)
    {
        if (this.isNormal)
        {
            if (this.graph.containsKey(name)) return new Vertex(name, this.graph.get(name));
    ...
    public void printGraph()
    {
        for (String key : this.graph.keySet())
        {
            ...
            for (String edge : this.graph.get(key)) System.out.print(edge + " ");
            System.out.println();
        }
    }
}
